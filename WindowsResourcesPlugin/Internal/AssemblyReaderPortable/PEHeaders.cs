    ...
    internal sealed class PEHeaders
    {
        ...
        public PEHeaders(Stream peStream, int size, bool isLoadedImage)
        {
            ...
            static int GetAndValidateSize(Stream stream, int size, string streamParameterName)
            {
                ...
                {
                    throw new ArgumentException("The stream is too large to be a valid PE image.", streamParameterName);
                }
            ...
            {
                throw new ArgumentException("The underlying stream must both support reading and seeking.", nameof(peStream));
            }
        ...
        private bool TryCalculateCorHeaderOffset(out int startOffset)
        {
            ...
            if (length < 72)
            {
                throw new BadImageFormatException("The COR header size is invalid.");
            }
        ...
        private static void SkipDosHeader(ref PEBinaryReader reader, out bool isCOFFOnly)
        {
            ...
            if (dosSig != DosSignature)
            {
                ...
                else
                {
                    ...
                    throw new BadImageFormatException("The image format of this stream is unknown.");
                }
            }
            else
            {
            ...
            if (!isCOFFOnly)
            {
                ...
                {
                    throw new BadImageFormatException("The PE signature is invalid.");
                }
            }
        }
        ...
        private SectionHeader[] ReadSectionHeaders(ref PEBinaryReader reader)
        {
            ...
            {
                throw new BadImageFormatException("The number of sections given is invalid.");
            }

            var ret = new SectionHeader[numberOfSections];

            for (int i = 0; i < numberOfSections; i++)
            {
                ret[i] = new SectionHeader(ref reader);
            }
        ...
        internal bool TryGetDirectoryOffset(DirectoryEntry directory, out int offset, bool canCrossSectionBoundary)
        {
            ...
            {
                throw new BadImageFormatException("The given section is too small.");
            }
        ...
        private void CalculateMetadataLocation(long peImageSize, out int start, out int size)
        {
            ...
            else
            {
                ...
                {
                    throw new BadImageFormatException("The data directory is missing from the PE file. Invalid file detected.");
                }
            ...
            {
                throw new BadImageFormatException("The data directory has an invalid structure. Invalid file detected.");
            }
        }
    }
}
