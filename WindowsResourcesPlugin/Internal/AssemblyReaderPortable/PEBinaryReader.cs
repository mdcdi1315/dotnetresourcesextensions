...
namespace DotNetResourcesExtensions.Internal.AssemblyReader
{
    ...
    internal readonly struct PEBinaryReader
    {
        ...
        private void CheckBounds(uint count)
        {
            ...
            {
                throw new System.BadImageFormatException("The image is too small so as to fit the requested bytes.");
            }
        }
        ...
        private void CheckBounds(long startPosition, int count)
        {
            ...
            {
                throw new System.BadImageFormatException("The image is too small or it's computed offsets are invalid.");
            }
        }
    }
}
