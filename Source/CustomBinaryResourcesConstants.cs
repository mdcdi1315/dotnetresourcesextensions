...
namespace DotNetResourcesExtensions.Internal
{
    ...
    internal sealed class CustomBinaryResource
    {
        ...
        private System.Int64 ReadNextNumericValue()
        {
            ...
            if (EnsureHeaderEnd() == false) { throw new FormatException("Corrupted resource format detected."); }
        ...
        private System.Byte[] ReadUntilHeaderEnd()
        {
            ...
            if (final == -1) { throw new FormatException("Failed to detect header end."); }
        ...
        public BinResourceBlob ReadResource(System.Int64 position , CustomFormatter.ICustomFormatter fmt)
        {
            ...
            {
                throw new FormatException("Invalid header start. Header must begin with RESOURCE.");
            }
            if (StringMatchesThis($"{CustomBinaryResourcesConstants.ResourceName}{CustomBinaryResourcesConstants.ValueStartChar}") == false)
            {
                throw new FormatException("Invalid header. Header must exactly contain the RESOURCENAME phrase.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the HEADERVERSION phrase.");
            }
            ...
            if ((v = ReadNextNumericValue()) > CustomBinaryResourcesConstants.CurrentHeaderVersion)
            {
                ...
                throw new FormatException($"Invalid header. Header version is {v} , which cannot be read by this reader.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the DOTNETTYPE phrase.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the RESOURCETYPE phrase.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the RESOURCESIZE phrase.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the VALUE phrase.");
            }
    ...
    internal sealed class CustomBinaryHeader
    {
        ...
        private System.Int64 ReadNextNumericValue()
        {
            System.Byte[] d = new System.Byte[8];
            rwstream.Read(d, 0, d.Length);
            if (EnsureHeaderEnd() == false) { throw new FormatException("Corrupted resource header format detected."); }
            return System.BitConverter.ToInt64(d, 0);
        }
        ...
        public CustomBinaryHeaderBlob ReadHeader(System.Int64 position)
        {
            ...
            {
                throw new FormatException("Cannot read the resource header. It's magic value is invalid.");
            }
            if (EnsureHeaderEnd() == false) { throw new FormatException("Corrupted resource header format detected."); }
            if (StringMatchesThis($"{CustomBinaryResourcesConstants.Version}{CustomBinaryResourcesConstants.ValueStartChar}") == false)
            {
                throw new FormatException("Invalid header. Header must exactly contain the VERSION phrase.");
            }
            ...
            if ((v = ReadNextNumericValue()) > CustomBinaryResourcesConstants.CurrentHeaderVersion)
            {
                ...
                throw new FormatException($"The format version is invalid: {v} . The reader can only read up to {CustomBinaryResourcesConstants.CurrentFormatVersion}.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the CURRENTFORMATS phrase.");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the SUPPORTEDHEADERVERSION phrase.");
            }
            if ((v = ReadNextNumericValue()) > CustomBinaryResourcesConstants.CurrentFormatVersion)
            {
                throw new FormatException($"Invalid header format version: {v} . This reader can only read up to version {CustomBinaryResourcesConstants.CurrentFormatVersion} .");
            }
            ...
            {
                throw new FormatException("Invalid header. Header must exactly contain the DATAPOSALIGNMENT phrase.");
            }
            if ((v = ReadNextNumericValue()) != CustomBinaryResourcesConstants.DataPositionsAlignment)
            {
                throw new FormatException("Invalid header. The specified data position alignment is possibly corrupted. This header stream is untrusted.");
            }
            ...
            if (ret.Version == 1) // Version 1
            {
                ...
                {
                    throw new FormatException("Invalid header. Header must exactly contain the DATAPOSITIONS phrase.");
                }
            ...
            } else if (ret.Version == 2) // Version 2
            {
                ...
                {
                    throw new FormatException("Invalid header. Header must exactly contain the DATAPOSITIONSCOUNT phrase.");
                }
                v = ReadNextNumericValue();
