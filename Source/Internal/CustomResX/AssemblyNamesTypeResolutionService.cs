...
internal class AssemblyNamesTypeResolutionService : ITypeResolutionService
{
    ...
    private static readonly string s_dotNetPath =
        ...
        Path.Combine(Environment.GetEnvironmentVariable("ProgramFiles") ?? string.Empty, "dotnet\\shared");
#else
        $"{Environment.GetEnvironmentVariable("WinDir")}\\Microsoft.NET\\Framework64";
#endif
...
#pragma warning restore SYSLIB0044 // Type or member is obsolete
    ...
    public Type? GetType(string name, bool throwOnError, bool ignoreCase)
    {
        ...
        {
            throw new ArgumentException(string.Format(Resources.InvalidResXNoType, name));
        }
